...
#data <- read_excel(paste0("input/", assessment.month, "2020-11_ETH_JMMI_dataset.xlsx"), guess_max = 20000)
data <- read_excel(paste0("input/2021-08_dataset_checked.xlsx"), guess_max = 20000)
